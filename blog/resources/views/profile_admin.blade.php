    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="profile-head">
                <hr>
                <h5><b>{{ $us->firstname }} {{ $us->lastname }}</b></h5>
                <hr>
            </div>
            <div class="tab-content profile-tab" id="myTabContent">
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <a href="{{ route('make_admin', ["id"=>$us->id]) }}">Сделать администратором</a>
                    <a href="{{ route('add_ban', ["id"=>$us->id]) }}">Забанить</a>
                    <a href="{{ route('unban', ["id"=>$us->id]) }}">Разбанить</a>
                </div>
            </div>
        </div>
    </div>
